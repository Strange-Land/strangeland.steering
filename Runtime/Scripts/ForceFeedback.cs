...
public class ForceFeedback : MonoBehaviour {
    ...
    void Update() {
        ...
        if (SteeringWheelManager.Instance != null) {
            if (ConnectionAndSpawning.Instance.ServerStateEnum.Value  is EServerState.Questions or EServerState.WaitingRoom) { //ToDo: this should be managed through the networkVehicleController
                ...
                else { SteeringWheelManager.Instance.SetConstantForce((int) (0), _participantOrder); }
